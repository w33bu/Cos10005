...
/* writethefunctiontoogle()that collapse/expanda section*/
function toggle (){
...
function init() {
	$(".collapse").click(toggle);	//link functiontoogle()to appropriate events
	$("#regform").submit(validate);	/*link function validate() to the submit event of the form*/
}
/* Display error messageifany error(s) is/are detected */
